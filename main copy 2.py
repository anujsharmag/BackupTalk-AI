...
# ==============================
# 📊 REAL BACKUP HEALTH DASHBOARD
# ==============================

st.markdown("---")
st.markdown("## 📊 Backup Health Dashboard")
st.markdown("This section provides real metrics and trends from your uploaded backup logs.")

# Check if logs are processed
if st.session_state.vectorstore:
    # Combine all uploaded logs into text
    combined_text = ""
    for file in uploaded_files:
