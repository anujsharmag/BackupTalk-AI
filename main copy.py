...
<div style="text-align: center; padding: 2rem 0;">
    <h1 style="color: #ff4b4b; font-size: 3rem; margin-bottom: 0.5rem;">💾 BackupTalk AI</h1>
    <p style="font-size: 1.2rem; color: #666; margin-bottom: 2rem;">Your AI Assistant for Smarter Backup Insights</p>
</div>
""", unsafe_allow_html=True)
...
# Main chat interface
st.markdown("### 💬 Talk to your data. Understand your backups ")
    ...
    if st.session_state.vectorstore and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching documents..."):
                ...
                system_prompt = f"""You are Backup Assistant, an intelligent Backup Error Assistant Chat BOT. 
...
<div style="text-align: center; color: #666; font-size: 0.9rem;">
    <p>🤖 Powered by Euri AI & LangChain | 🏥 Backup Assistant Intelligence Chat BOT</p>
</div>
""", unsafe_allow_html=True)    
